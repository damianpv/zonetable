...
from zonetable.apps.sorl.thumbnail.helpers import serialize, deserialize, ThumbnailError
from zonetable.apps.sorl.thumbnail.images import serialize_image_file, deserialize_image_file
