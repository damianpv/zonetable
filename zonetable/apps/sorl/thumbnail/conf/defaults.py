...
# Backend
THUMBNAIL_BACKEND = 'zonetable.apps.sorl.thumbnail.base.ThumbnailBackend'
...
THUMBNAIL_KVSTORE = 'zonetable.apps.sorl.thumbnail.kvstores.cached_db_kvstore.KVStore'
...
THUMBNAIL_ENGINE = 'zonetable.apps.sorl.thumbnail.engines.pil_engine.Engine'
